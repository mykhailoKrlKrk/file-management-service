...
@Tag(
        ...
        description = "Operations for uploading, replacing, deleting and retrieving customer JSON files."
)
...
public class FileManagementController {
    ...
    @Operation(
            ...
            description = """
                    Retrieves a file as a downloadable resource using the required name format:
                    <customerName>_<type>_<dd.mm.yyyy>.xml
